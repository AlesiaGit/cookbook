...
class ChangeCategory extends Component {
    constructor(props) {
        ...
        let categoryId = this.props.location.pathname
            .split("/change-category/")
            .pop();
        let selectedCategory = this.props.categories.array.filter(
    ...
    componentWillMount = () => {
        ...
        this.setState({
            ...
            categoryName:
                this.state.selectedCategory.name === "Без названия"
                    ? ""
    ...
    saveCategory = () => {
        ...
        var categories = this.props.categories.array.map(
            elem => (elem.id === this.state.categoryId ? changedCategory : elem)
        );
    ...
    render() {
        ...
        return (
            <div className="wrapper">
                <div
                    className="change-category__header header"
                ...
                >
                    ...
                    <div className="change-category__header-title">
                        Изменить категорию
                    </div>
                ...
                <div className="body change-category__body">
                    <div className="change-category__body-section">
                        <div className="change-category__body-section-title">
                            Название папки
                        </div>
                        <input
