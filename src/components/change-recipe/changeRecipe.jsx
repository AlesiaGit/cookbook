...
class ChangeRecipe extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            recipe: this.props.recipes.array.filter(
                elem =>
                    elem.id ===
                    window.location.hash.split("/change-recipe/").pop()
            )[0],
            ingredientName: "",
            ingredientQuantity: "",
            ingredientUnits: "мл",
        ...
        this.setState(
            {
                ...
                recipeName:
                    this.state.recipe.title === "Без названия"
                        ? ""
                        : this.state.recipe.title,
                recipeCookHours:
                    this.state.recipe.cooktime.hours === "0"
                        ? ""
                        : this.state.recipe.cooktime.hours,
                recipeCookMinutes:
                    this.state.recipe.cooktime.minutes === "00"
                        ? ""
                        : this.state.recipe.cooktime.minutes,
    ...
    saveRecipe = () => {
        ...
        let menuRecipes = recipes.filter(
    ...
    render() {
        ...
        return (
            <div className="wrapper">
                <div
                    className="change-recipe__header header"
                ...
                >
                    ...
                    <div className="change-recipe__header-title">
                        Изменить рецепт
                    </div>
                    <div
                        className="change-recipe__header-right-menu"
                ...
                <div className="change-recipe__scroll">
                    ...
                    >
                        <label className="change-recipe__add-picture-icon">
                            <input
                                type="file"
                                className="change-recipe__add-picture-input"
                                onChange={this.handleFileUpload}
                            />
                        </label>
                        <div className="change-recipe__add-picture-text">
                            Изменить фотографию
                        </div>
                    </div>
                    <div
                    ...
                    <div className="change-recipe__body">
                        <div className="change-recipe__body-section">
                            <div className="change-recipe__body-section-title">
                                Название рецепта
                            </div>
                            <input
                                className="change-recipe__body-section-input"
                        ...
                        <div className="change-recipe__body-section">
                            ...
                            <div className="change-recipe__subsections-wrapper">
                                <div className="change-recipe__subsection-ingredients">
                                    ...
                                    <span className="change-recipe__ingredient-divider">
                                        -
                                    </span>
                                    <input
