...
class CategoriesList extends Component {
    ...
    changeOrder = (order, sortable, evt) => {
        ...
        categories.splice(
            evt.newIndex,
            0,
            categories.splice(evt.oldIndex, 1)[0]
        );
        this.setState({
                ...
                >
                    {this.state.categoriesFromDom.map((item, index) => (
                        <div
                            ...
                            style={{
                                backgroundColor:
                                    item === this.props.selectedCategory
                                        ? "#f0f0f0"
                                        : "#ffffff"
                            }}
                        >
                            <div
                                className={
                                    item === this.props.selectedCategory
                                        ? "drawer__drag-icon white"
                                        : "drawer__drag-icon grey"
                                }
                            />
                            <div className="drawer__left">
                                ...
                                >
                                    <div
                                        ...
                                        style={this.props.drawCategoryIcon(
                                            item
                                        )}
                                    />
                                    <div className="drawer__category-data">
                                        ...
                                        <div className="drawer__category-recipes-count">
                                            {this.props.writeRecipesCount(
                                                item.id
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div
                                    className="drawer__dots-menu-btn"
                                    onClick={event => {
                                        this.toggleItemMenu(
                                            event.clientX,
                                            event.clientY,
