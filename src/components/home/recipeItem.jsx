        ...
        <div className="category__list-row">
            {props.rowData.map((elem, index) => (
    	        <Link
                    ...
                    to={(elem === undefined) ? '/' : "/recipe/" + props.recipes[props.rowIndex * 2 + index].id}
    	            ...
    	            <div className="category__list-info-wrapper">
                        <div className="category__list-icon" style={props.addIcon(props.recipes[props.rowIndex * 2 + index])}></div>
