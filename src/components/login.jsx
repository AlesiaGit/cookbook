...
class Login extends Component {
    ...
    componentWillMount = () => {
        ...
        this.removeListener = auth.onAuthStateChanged(user => {
            if (user) {
                Promise.resolve(store.dispatch(userLoggedIn(user.uid))).then(
                    data => {
                ...
                Promise.resolve(store.dispatch(userLoggedOut()))
                    .then(data => {
                        let empty = [];
        ...
        return (
            <div className="login__wrapper">
                ...
                <div className="login__form-wrapper">
                    ...
                    />
                    <div className="error" style={{ visibility: emailError }}>
                    ...
                    <div
                        className="error"
                        style={{ visibility: passwordError }}
                    >
